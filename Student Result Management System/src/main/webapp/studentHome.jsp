...
<center><img src="surydatta.jpeg" width="150" height="150">
...
body{
  ...
  <div class="tbl-header">
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          <th>institution Name: Surydatta</th>
...
<body>
  <table>
    ...
    <tbody>
      ...
      <tr>
        <td>NAS103</td>
        <td colspan="2">Business Stasticis </td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>NEE101</td>
        <td colspan="2">softwere enginerring </td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>NEC101</td>
        <td colspan="2">web develpoment</td>
        <td>Theory</td>
        <td>100</td>
        <td> 30 </td>
      ...
      <tr>
        <td>NAS152</td>
        <td colspan="2">Data sturcture and Algorithim</td>
        <td>Practical</td>
        <td>30</td>
        <td>15</td>
...
Designed & Developed by MCA Days Team</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ MCA Days :: 2024-2026</h6></center> 
  <hr class="new1">
</body>
<%}
else{
